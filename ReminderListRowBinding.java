...
public final class ReminderListRowBinding implements ViewBinding {
  ...
  private ReminderListRowBinding(@NonNull CardView rootView, @NonNull TextView reminderDofTvw,
  ...
  public static ReminderListRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ReminderListRowBinding((CardView) rootView, reminderDofTvw,
