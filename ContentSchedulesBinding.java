...
public final class ContentSchedulesBinding implements ViewBinding {
  @NonNull
  ...
  private ContentSchedulesBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ContentSchedulesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ContentSchedulesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.content_schedules, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ContentSchedulesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentSchedulesBinding((LinearLayout) rootView, raEmptyStateLinearLayout,
